...
# Htet Aung Hlaing
# Mini Project 3: Recipe Flask App
...
# The goal here is to come up with a small web application that meets the requirements below.
# If you get stuck here, please email me!
...
# (5/5 points) I will be checking out the main branch of your project. Please be sure to include a requirements.txt file
# which contains all the packages that need installed. You can create this fille with the output of pip freeze at the terminal prompt.
...
# Be thorough on the explanations. You will need to explain the steps of initializing the database and
# then how to run the development server for your project.
